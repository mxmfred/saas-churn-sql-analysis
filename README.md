...
\
- `accounts` \'96 customer metadata  \
- `subscriptions` \'96 subscription lifecycles, plan tiers, revenue  \
- `feature_usage` \'96 daily product usage logs  \
- `support_tickets` \'96 support interactions  \
- `churn_events` \'96 churn dates and reasons  \
\
